...
Since both are only line 1, I selected one of the patterns as the comparison. I wanted to see if the lines containing regular expression I wrote is are the same as those that contain the SnortId / Title, thereby proving the regular expression I wrote is correct. 
