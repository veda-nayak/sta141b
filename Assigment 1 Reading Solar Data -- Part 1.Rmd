...
{
    # First read the values in the table, and ignore the header/column names (first line)
    firstLine = tt[1]
...
readNCBITables2 = # read table data >hours 1-24 for each day
